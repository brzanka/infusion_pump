...
mainMenu dose1 = { "D:1ml", &dose2, &dose5, &newM, &velocity1, 5, 0, setParameters};
mainMenu dose2 =  { "D:2ml", &dose3, &dose1, &newM, &velocity1, 10, 0, setParameters};
mainMenu dose3 = { "D:3ml", &dose4, &dose2, &newM, &velocity1, 15, 0, setParameters};
mainMenu dose4 =  { "D:4ml", &dose5, &dose3, &newM, &velocity1, 20, 0, setParameters};
mainMenu dose5 = { "D:5ml", &dose1, &dose4, &newM, &velocity1, 25, 0, setParameters};
